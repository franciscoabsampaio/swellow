...
def main():
    ...
    # Define common arguments to keep code DRY
    base_config = {
        "db": db_conn,
        "directory": mig_dir,
        "engine": "postgres",
